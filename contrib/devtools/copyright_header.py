...
# Copyright (c) 2018-2023 The hemis Core developers
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The hemis Core developers'
...
Arguments:
    <base_directory> - The base directory of a hemis source code repository.
"""
...
CPP_HEADER = '''
// Copyright (c) %s The hemis Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.
'''
...
def exec_insert_header(filename, style):
    ...
    if file_already_has_core_copyright(file_lines):
        sys.exit('*** %s already has a copyright by The hemis Core developers'
                 % (filename))
