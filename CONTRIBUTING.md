...
[Translation Process](https://github.com/Hemis-blockchain/Hemis/blob/master/doc/translation_process.md)
...
The following applies to code changes to the Hemis Core project, and is not to be
confused with overall Hemis Network Protocol consensus changes.

Whether a pull request is merged into Hemis Core rests with the project merge
...
Patches that change Hemis consensus rules are considerably more involved than
...
Where a patchset proposes to change the Hemis consensus, it must have been
...
The project leader is the release manager for each Hemis Core release.
