...
class ListReceivedTest (HemisTestFramework):
    ...
    def run_test(self):
        ...
        self.nodes[0].sendtoaddress(taddr, 6.0) # node_1 in taddr with 6 HMS.
        ...
        # Send 1 HMS to shield addr1
        txid = self.nodes[1].shieldsendmany(taddr, [ # node_1 with 6 HMS sending them all (fee is 0.1 HMS)
        ...
        # Confirm transaction (2 HMS from taddr to shield_addr1)
        ...
        txid = self.nodes[1].shieldsendmany(shield_addr1, # shield_addr1 has 2 HMS, send 0.6 HMS + 0.05 HMS fee
