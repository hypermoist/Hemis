...
class NetTest(HemisTestFramework):
    ...
    def _test_getnodeaddresses(self):
        ...
        self.nodes[0].addpeeraddress(ipv6_addr, 49165)
        ...
        for i in range(10000):
            ...
            self.nodes[0].addpeeraddress(a, 49165)
