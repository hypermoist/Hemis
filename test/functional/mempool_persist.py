...
By default, Hemisd will dump mempool on shutdown and
...
class MempoolPersistTest(HemisTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent Hemisd from writing mempool.dat to disk. Verify that `savemempool` fails")
