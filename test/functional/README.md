...
- Use a module-level docstring to describe what the test is testing, and how it
  is testing it.
- When subclassing the HemisTestFramwork, place overrides for the
...
with the hemisd(s) being tested in a callback-based event loop; the other
implements the test logic.

- `P2PConnection` is the class used to connect to a hemisd.  `P2PInterface`
...
Basic code to support P2P connectivity to a hemisd.
