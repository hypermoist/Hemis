...
"""Verify that starting hemis with -h works as expected."""
...
class HelpTest(HemisTestFramework):
    ...
    def run_test(self):
        self.log.info("Start hemis with -? for help text")
        ...
        self.log.info("Start hemis with -version for version information")
