...
2. autocombinerewards feature - Automatically combines gamemaster reward once spendable into a single input.
...
6. Multisend now can filter between staking and gamemaster rewards (soon). Also some bugs addressed.
...
10. Added Fallback Seed Nodes - You no longer need to add initial addnodes lines to Hemis.conf!
