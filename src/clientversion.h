...
#error Client version information missing: version is not defined by Hemis-config.h or in any other way
#endif
...
/**
 * Hemisd-res.rc includes this file, but it cannot cope with real c++ code.
