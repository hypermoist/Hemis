...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(HMS);
    unitlist.append(mHMS);
    unitlist.append(uHMS);
    return unitlist;
}
...
QString BitcoinUnits::floorWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool isZHMS)
{
    QSettings settings;
    ...
    return result + QString(" ") + name(unit, isZHMS);
}

QString BitcoinUnits::floorHtmlWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool isZHMS)
{
    QString str(floorWithUnit(unit, amount, plussign, separators, cleanRemainderZeros, isZHMS));
    str.replace(QChar(THIN_SP_CP), QString(COMMA_HTML));
    return QString("<span style='white-space: nowrap;'>%1</span>").arg(str);
}
