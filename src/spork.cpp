...
std::vector<CSporkDef> sporkDefs = {
    MAKE_SPORK_DEF(SPORK_7_GAMEMASTER_PAYMENT_ENABLE,       4070908800ULL), // OFF
    MAKE_SPORK_DEF(SPORK_8_GAMEMASTER_PAYMENT_ENFORCEMENT,  4070908800ULL), // OFF
    MAKE_SPORK_DEF(SPORK_9_GAMEMASTER_BUDGET_ENFORCEMENT,   4070908800ULL), // OFF
    ...
    MAKE_SPORK_DEF(SPORK_20_SAPLING_MAINTENANCE,            1),             // ON
    MAKE_SPORK_DEF(SPORK_21_LEGACY_GMS_MAX_HEIGHT,          4070908800ULL), // OFF
    MAKE_SPORK_DEF(SPORK_22_LLMQ_DKG_MAINTENANCE,           1),             // OFF
...
// Hemis: on startup load spork values from previous session if they exist in the sporkDB
